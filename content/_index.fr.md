...
<div class="hx:mt-8 hx:flex hx:flex-wrap hx:items-center hx:justify-center hx:gap-2">
  ...
  <a href="/fr/" class="hx:inline-flex hx:items-center hx:px-4 hx:py-1.5 hx:rounded-full hx:bg-primary-600 hx:text-white hx:font-medium hx:no-underline hx:transition hx:hover:opacity-90">Français</a>
